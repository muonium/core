...
?>
        ...
        <section id="toolbar">
            ...
            <div class="selected" onclick="QuantaCloud.clickEvent(this,'DefaultAction','Partage')" id="toolbar_button_share"><img src="./public/pictures/toolbar/share.svg" /><br />Partagés</div>
        ...
        <section id="desktop">
            <img src="./public/pictures/desktop/arrow.svg" class="arrow shares" />
