...
?>
        ...
        <section id="toolbar">
            <div class="selected" onclick='QuantaCloud.clickEvent(this,"DefaultAction","Recent")' id="toolbar_button_recents"><img src="./public/pictures/toolbar/recent.svg" /><br />Récents</div>
